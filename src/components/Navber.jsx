    ...
    <div className="max-w-[1200px] mx-auto px-3 md:px-0   flex items-center justify-between bg-opacity-90   z-20 fixed top-0 left-0 right-0 h-[80px]  ">
      ...
      <div className="navbar-end">
        <div className="flex items-center space-x-4">
          ...
          <div className="dropdown dropdown-end">
            <div className="flex items-center cursor-pointer gap-2">
              <div className="indicator mr-2">
                <span className="text-whit text-xl  hover:text-green-600">🛒</span>
          ...
          {/* Sign In Button */}
          <Link href="/signin" className="md:px-6 md:py-3 border border-gray-700 text-gray-800 rounded-sm md:ml-[16px] hidden md:block">
            Sign in
          </Link>
